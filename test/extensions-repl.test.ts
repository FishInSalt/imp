...
`,
		...
		const replAt = out.indexOf("Tips for getting started:"); // fresh session → welcome panel
...
`,
		...
		expect(env.output()).toContain(
			"known: /help /exit /new /fork /tree /sessions /resume /model /login /logout /think /worktrees /trust /status /settings /copy /name /compact /extcmd — /help shows what they do",
		);
